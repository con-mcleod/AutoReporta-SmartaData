...
adelaide=`wget -q -O- "http://www.bom.gov.au/jsp/ncc/cdio/weatherData/av?p_nccObsCode=193&p_display_type=dailyDataFile&p_startYear=2017&p_c=-106946031&p_stn_num=023123" | egrep "<tr><th scope=" | tr '\D' ',' | tr '<|>|/' ' ' | tr 'td' ' '`
